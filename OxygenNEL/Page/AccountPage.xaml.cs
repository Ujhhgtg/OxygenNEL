...
{
    public sealed partial class AccountPage : Microsoft.UI.Xaml.Controls.Page
    {
        public static string PageTitle => "账号管理";
        ...
        public AccountPage()
        {
            ...
            {
                Log.Warning(ex, "AccountPage 初始化失败");
            }
        }
        ...
        private ContentDialog CreateDialog(object content, string title)
        {
            ...
            {
                XamlRoot = MainWindow.DialogXamlRoot ?? this.XamlRoot,
